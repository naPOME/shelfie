      ...
      <div className="grid max-w-screen-xl px-4 py-5 mx-auto lg:gap-8 xl:gap-0 lg:py-24 lg:grid-cols-12">
        ...
        <div className="hidden lg:mt-0 lg:col-span-5 lg:flex justify-around gap-5 pb-20">
          <div className="flex flex-col items-center h-48">
            <img src="https://imgs.search.brave.com/dyyrSJucH0LG3bsMXX8RR_4OJgje1opM6W2o9rAqzzc/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93d3cu/YWRhemluZy5jb20v/d3AtY29udGVudC91/cGxvYWRzLzIwMjIv/MTIvSGFycnktUG90/dGVyLUJvb2stQ292/ZXJzLVByaXNvbmVy/cy1vZi1BemthYmFu/LXVzLmpwZw" alt="Mockup 1" className="h-72  w-60 object-cover rounded-t-full"/>
          ...
          <p className='text-black text-sm font-bold'>Prison of Azkban</p>
            ...
            <img src="https://imgs.search.brave.com/O-niKVRrfx0FfkSJnO3F-OxUo_RBxVloWKKqowj8HZQ/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93d3cu/YWRhemluZy5jb20v/d3AtY29udGVudC91/cGxvYWRzLzIwMjIv/MTIvSGFycnktUG90/dGVyLUJvb2stQ292/ZXJzLVBoaWxvc29w/aGVycy1TdG9uZS11/cy0yLmpwZw" alt="Mockup 2" className=" h-72 w-60 object-cover rounded-b-full"/>
          </div>

          <div className="flex flex-col items-center h-48 ">
            <img src="https://imgs.search.brave.com/oFjgc_DjV2z1cmdEJhK-mMLkk5P3Za1CHm5QWJ_DMOo/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93d3cu/YWRhemluZy5jb20v/d3AtY29udGVudC91/cGxvYWRzLzIwMjIv/MTIvSGFycnktUG90/dGVyLUJvb2stQ292/ZXJzLVBoaWxvc29w/aGVycy1TdG9uZS11/ay0yLTY2N3gxMDI0/LmpwZw" alt="Mockup 3" className="rounded-t-full h-72 w-60 object-cover"/>
