...
const Navbar: React.FC<{ showProfile: () => void }> = ({ showProfile }) => {
  ...
  return (
    <div className="flex justify-center w-full bg-gray-50 ">
      <nav className="flex justify-between items-center px-10 py-4 bg-gray-50 rounded-lg shadow-sm font-sans border-b-2 border-gray-300 w-4/5">
        ...
        <div className="flex items-center space-x-2">
         ...
         <Link href={'/'}> <h1 className="text-2xl text-black font-medium">SHELFie</h1></Link>
        </div>
