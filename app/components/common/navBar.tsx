...
const Navbar: React.FC = () => {
  return (
    <nav className="flex justify-between items-center px-10 py-4 bg-gray-50 rounded-3xl shadow-md font-sans">
      {/* Logo */}
...
<img src="https://cdn0.iconfinder.com/data/icons/education-illustration-pack/128/Bookshelf-256.png" className='h-5 w-5' alt="" />
      <h1 className="text-2xl text-gray-800 font-medium ">SHELFie</h1>
      </div>
      ...
      <div className="flex items-center space-x-4">
        {/* Book Icon */}
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-700 hover:text-gray-900" viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        <div className="relative ">
          ...
          <svg
            ...
            className="absolute -bottom-1 -right-1 h-4 w-4 bg-white text-gray-500 rounded-full  border border-gray-200 p-0.5 cursor-pointer"
            viewBox="0 0 20 20"
            fill="currentColor"
          >
